...
package app.kimyeonjung.og.core.bluetooth;
...
public class DeviceList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int layoutText = getIntent().getIntExtra("layout_text", R.layout.bluetooth_device_name);
        mPairedDevicesArrayAdapter = new ArrayAdapter<>(this, layoutText);
